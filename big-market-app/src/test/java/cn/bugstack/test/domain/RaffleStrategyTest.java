...
import cn.bugstack.domain.strategy.service.rule.filter.impl.RuleLockLoginFilter;
...
public class RaffleStrategyTest {
    ...
    @Autowired
    private RuleLockLoginFilter ruleLockLoginFilter;
    ...
    public void setUp() {
        ...
        ReflectionTestUtils.setField(ruleLockLoginFilter, "userRaffleCount", 0L);
    }
