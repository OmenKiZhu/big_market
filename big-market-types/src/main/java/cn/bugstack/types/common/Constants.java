...
public class Constants {
    ...
    public static class RedisKey {
        ...
        public static String STRATEGY_AWARD_KEY = "big_market_strategy_award_list_key_";
        public static String STRATEGY_AWARD_LIST_KEY = "big_market_strategy_award_key_";
